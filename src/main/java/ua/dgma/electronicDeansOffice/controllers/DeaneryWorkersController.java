...
import ua.dgma.electronicDeansOffice.services.impl.DeaneryWorkerService;
...
public class DeaneryWorkersController {
    ...
    private final DeaneryWorkerService deaneryWorkerService;
    private final DeaneryWorkerMapper deaneryWorkerMapper;
    private final DeaneryWorkerListMapper deaneryWorkerListMapper;

    @Autowired
    public DeaneryWorkersController(DeaneryWorkerService deaneryWorkerService,
